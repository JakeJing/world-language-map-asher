...
prepare_geojson_data <- function(path) {
  ...
  families_sf <- st_read(glue("{path}/families.geojson"), quiet = TRUE)
...
create_family_maps <- function(family_name, traditional_sf, contemporary_sf) {
  ...
  tagList(
    div(
      ...
      div(
        style = "flex: 1;",
        h4(paste(family_name, "Traditional Map"), style = "text-align: center;"),
        leaflet() %>%
          addTiles() %>%
          addPolygons(
      ...
      div(
        style = "flex: 1;",
        h4(paste(family_name, "Contemporary Map"), style = "text-align: center;"),
        leaflet() %>%
          addTiles() %>%
          addPolygons(
...
tagList(
  div(
    ...
    div(
      ...
      h4("Traditional Data", style = "text-align: center;"),
      leaflet() %>%
        addTiles() %>%
        addPolygons(
          data = traditional_sf,
    ...
    div(
      style = "flex: 1; height: 350px;",
      h4("Contemporary Data", style = "text-align: center;"),
      leaflet() %>%
        addTiles() %>%
        addPolygons(
...
tagList(
  div(
    ...
    div(
      style = "flex: 1;",
      h4("Traditional Language Database", style = "text-align: center;"),
      datatable(
        traditional_sf %>%
        ...
        caption = "Traditional Language Database"
      )
    ),
    div(
      style = "flex: 1;",
      h4("Contemporary Language Database", style = "text-align: center;"),
      datatable(
        contemporary_sf %>%
          select(title, Family, Glottocode) %>%
          st_drop_geometry(),
        ...
        caption = "Contemporary Language Database"
      )
    )
  )
)
